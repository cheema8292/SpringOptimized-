if (!customElements.get('recipient-form')) {
  customElements.define(
    ...
    class RecipientForm extends HTMLElement {
      constructor() {
        super();
        this.recipientFieldsWrapper = this.querySelector('[data-recipient-fields-wrapper]');
      ...
      onChange() {
        if (this.checkboxInput.checked) {
          this.recipientFieldsWrapper.classList.add('active');
          this.enableInputFields();
          this.recipientFieldsLiveRegion.innerText = window.accessibilityStrings.recipientFormExpanded;
        } else {
          this.recipientFieldsWrapper.classList.remove('active');
      ...
      createErrorListItem(target, message) {
        ...
        a.innerText = message;
        li.appendChild(a);
        li.className = 'error-message form-message form-message-error text-small';
        return li;
      }
